...
-- AlterTable
ALTER TABLE "Name" ALTER COLUMN "creatorId" SET DATA TYPE TEXT;
...
-- AddForeignKey
ALTER TABLE "Name" ADD CONSTRAINT "Name_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
